...
public class Validator {
    ...
    /**
     * Validates and parses a string into a Date object based on a specific
     * format.
     *
     * @param input the string input from the user.
     * @param format the date pattern (e.g., "dd-MM-yyyy").
     * @return a valid Date object.
     * @throws Exception if the input is empty, wrong format, or an invalid date
     * (e.g., 31/02).
     */
    public static Date validateDate(String input, String format) throws Exception {
        SimpleDateFormat sdf = new SimpleDateFormat(format);
        // setLenient(false) ensures strict date checking (e.g., 31/02 will be rejected)
        ...
        try {
            ...
            throw new Exception("Invalid date! Please follow the format: " + format);
        }
    }
}
